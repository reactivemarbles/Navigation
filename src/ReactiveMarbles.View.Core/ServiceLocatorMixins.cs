...
public static class ServiceLocatorMixins
{
    ...
    public static void AddNavigationView<TViewModel, TView>(this IServiceLocator serviceLocator)
    ...
    public static void AddNavigationView<TViewModel, TView>(this IServiceLocator serviceLocator, string contract)
       where TView : class, IAmViewFor<TViewModel>, new()
       where TViewModel : class, IRxNavBase
    {
        if (serviceLocator == null)
